...
var keepkeyCountDownDate = new Date("Nov 31, 2019 23:59:59").getTime();
var bitcoin5CountDownDate = new Date("Nov 15, 2019 23:59:59").getTime();
var amazon5CountDownDate = new Date("Nov 15, 2019 23:59:59").getTime();
